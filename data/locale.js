...
(function () {
  const esEn = {
    ...
    'Atajos': 'Shortcuts', 'Atajos de teclado': 'Keyboard Shortcuts',
    'Envía una combinación de teclas al equipo conectado con un toque. Elige la categoría según el sistema o la app que estés usando.':
      'Sends a key combination to the connected computer with one tap. Choose the category for the system or app you are using.',
    'Categoría de atajos': 'Shortcut category', 'Atajos disponibles': 'Available shortcuts',
    'No se pudo enviar el atajo.': 'Could not send the shortcut.', 'Atajo enviado': 'Shortcut sent',
    'Teclas básicas': 'Basic Keys', 'Navegación': 'Navigation', 'Edición': 'Editing',
    'Navegador': 'Browser', 'Medios / YouTube': 'Media / YouTube', 'Presentación': 'Presentation',
    'Teclas de función': 'Function Keys',
    'Retroceso': 'Backspace', 'Suprimir': 'Delete', 'Espacio': 'Space', 'Tecla de menú': 'Menu key',
    'Arriba': 'Up', 'Abajo': 'Down', 'Izquierda': 'Left', 'Derecha': 'Right',
    'Fin': 'End', 'Re Pág': 'Page Up', 'Av Pág': 'Page Down',
    'Copiar (Ctrl+C)': 'Copy (Ctrl+C)', 'Pegar (Ctrl+V)': 'Paste (Ctrl+V)', 'Cortar (Ctrl+X)': 'Cut (Ctrl+X)',
    'Deshacer (Ctrl+Z)': 'Undo (Ctrl+Z)', 'Rehacer (Ctrl+Y)': 'Redo (Ctrl+Y)',
    'Seleccionar todo (Ctrl+A)': 'Select All (Ctrl+A)', 'Buscar (Ctrl+F)': 'Find (Ctrl+F)',
    'Nuevo (Ctrl+N)': 'New (Ctrl+N)', 'Abrir (Ctrl+O)': 'Open (Ctrl+O)', 'Guardar (Ctrl+S)': 'Save (Ctrl+S)',
    'Imprimir (Ctrl+P)': 'Print (Ctrl+P)', 'Pegar sin formato (Ctrl+Shift+V)': 'Paste Plain (Ctrl+Shift+V)',
    'Ejecutar (Win+R)': 'Run (Win+R)', 'Explorador (Win+E)': 'Explorer (Win+E)',
    'Mostrar escritorio (Win+D)': 'Show Desktop (Win+D)', 'Bloquear (Win+L)': 'Lock (Win+L)',
    'Buscar (Win+S)': 'Search (Win+S)', 'Configuración (Win+I)': 'Settings (Win+I)',
    'Menú avanzado (Win+X)': 'Power User Menu (Win+X)', 'Portapapeles (Win+V)': 'Clipboard (Win+V)',
    'Panel de emojis (Win+.)': 'Emoji Panel (Win+.)', 'Proyectar pantalla (Win+P)': 'Project Display (Win+P)',
    'Cambiar tarea (Alt+Tab)': 'Task Switch (Alt+Tab)', 'Vista de tareas (Win+Tab)': 'Task View (Win+Tab)',
    'Administrador de tareas (Ctrl+Shift+Esc)': 'Task Manager (Ctrl+Shift+Esc)',
    'Cerrar app (Alt+F4)': 'Close App (Alt+F4)', 'Ctrl+Alt+Supr': 'Ctrl+Alt+Del',
    'Recorte (Win+Shift+S)': 'Snipping (Win+Shift+S)', 'Imprimir pantalla': 'Print Screen',
    'Captura de ventana (Alt+ImpPant)': 'Active Screenshot (Alt+PrtSc)',
    'Reiniciar gráficos (Win+Ctrl+Shift+B)': 'Reset Graphics (Win+Ctrl+Shift+B)',
    'Terminal (Ctrl+Alt+T)': 'Terminal (Ctrl+Alt+T)', 'Bloquear (Ctrl+Alt+L)': 'Lock (Ctrl+Alt+L)',
    'Spotlight (Cmd+Espacio)': 'Spotlight (Cmd+Space)', 'Cambiar app (Cmd+Tab)': 'App Switch (Cmd+Tab)',
    'Forzar cierre (Cmd+Opt+Esc)': 'Force Quit (Cmd+Opt+Esc)', 'Ocultar app (Cmd+H)': 'Hide App (Cmd+H)',
    'Cerrar app (Cmd+Q)': 'Quit App (Cmd+Q)',
    'Barra de direcciones (Ctrl+L)': 'Address Bar (Ctrl+L)', 'Nueva pestaña (Ctrl+T)': 'New Tab (Ctrl+T)',
    'Cerrar pestaña (Ctrl+W)': 'Close Tab (Ctrl+W)', 'Reabrir pestaña (Ctrl+Shift+T)': 'Reopen Tab (Ctrl+Shift+T)',
    'Ventana privada (Ctrl+Shift+N)': 'Private Window (Ctrl+Shift+N)', 'Recargar (Ctrl+R)': 'Refresh (Ctrl+R)',
    'Pantalla completa (F11)': 'Full Screen (F11)', 'Atrás (Alt+Izquierda)': 'Back (Alt+Left)',
    'Adelante (Alt+Derecha)': 'Forward (Alt+Right)', 'Pestaña siguiente (Ctrl+Tab)': 'Next Tab (Ctrl+Tab)',
    'Pestaña anterior (Ctrl+Shift+Tab)': 'Prev Tab (Ctrl+Shift+Tab)', 'Acercar (Ctrl+=)': 'Zoom In (Ctrl+=)',
    'Alejar (Ctrl+-)': 'Zoom Out (Ctrl+-)', 'Restablecer zoom (Ctrl+0)': 'Zoom Reset (Ctrl+0)',
    'Herramientas de desarrollo (Ctrl+Shift+I)': 'Dev Tools (Ctrl+Shift+I)',
    'Reproducir/Pausar (Espacio)': 'Play/Pause (Space)', 'YouTube Reproducir/Pausar (K)': 'YouTube Play/Pause (K)',
    'YouTube Silenciar (M)': 'YouTube Mute (M)', 'YouTube Pantalla completa (F)': 'YouTube Fullscreen (F)',
    'YouTube Subtítulos (C)': 'YouTube Captions (C)', 'YouTube Subir volumen (Arriba)': 'YouTube Vol Up (Up)',
    'YouTube Bajar volumen (Abajo)': 'YouTube Vol Down (Down)', 'YouTube Retroceder 10s (J)': 'YouTube Back 10s (J)',
    'YouTube Avanzar 10s (L)': 'YouTube Forward 10s (L)', 'YouTube Anterior (Shift+P)': 'YouTube Previous (Shift+P)',
    'YouTube Siguiente (Shift+N)': 'YouTube Next (Shift+N)',
    'Iniciar (F5)': 'Start (F5)', 'Diapositiva actual (Shift+F5)': 'Current Slide (Shift+F5)',
    'Pantalla negra (B)': 'Black Screen (B)',
    'F1 Ayuda': 'F1 Help', 'F2 Renombrar': 'F2 Rename', 'F5 Recargar': 'F5 Refresh',
    'F12 Herramientas de desarrollo': 'F12 Dev Tools',
